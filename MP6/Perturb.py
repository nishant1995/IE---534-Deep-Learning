...
accuracy = ( float( prediction.eq(Y_batch.data).sum() ) /float(128))*100.0
print("Accuracy of Real images: {}".format(accuracy))
...
prediction = output.data.max(1)[1] # first column has actual prob.
accuracy = ( float( prediction.eq(Y_batch.data).sum() ) /float(128))*100.0
print("Accuracy of fake images: {}".format(accuracy))
